\documentclass[a4paper, 11pt, oneside, polutonikogreek, italian, landscape]{article}
\usepackage{lmodern}
...
\usepackage[top=60mm, bottom=60mm, outer=107mm, inner=107mm]{geometry}
\setlength{\columnsep}{90pt}
\usepackage{etoolbox}    % for \patchcmd
\usepackage{sectsty}
\usepackage{tocloft}

\allsectionsfont{\tiny\bfseries}
\sectionfont{\tiny\bfseries}
\subsectionfont{\tiny\bfseries}
\subsubsectionfont{\tiny\bfseries}
...
\AddToShipoutPictureBG{\includegraphics[width=\paperwidth,height=\paperheight]{murex-2.jpg}}
...
\begin{titlepage}
    ...
    % Title
    % -------------------------------------------------
    {\scshape\large Libellum de Restitutione Purpurarum}\\[0.1\baselineskip]
    ...
    % -------------------------------------------------
    {\scshape\scriptsize Tertio editum, emendatum, et auctum \\\normalsize Paschalis Amatius}

    {\scshape\scriptsize Sabinianensis\\Jurisconsultus\\D. D. D.}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth,keepaspectratio]{cover.png}
    \end{figure}

    \vfill

    {\scshape\footnotesize Cæsenæ, 1784\\\scriptsize Typis Gregorii Blasinii\\Præsidibus annuentibus}
 
    % -------------------------------------------------
    % Edition / license line
    % -------------------------------------------------
    {\scshape\footnotesize Solar Anamnesis Edition}\\[0.1\baselineskip]
    {\scshape\scriptsize CC0 1.0 Universale}
\end{titlepage}
