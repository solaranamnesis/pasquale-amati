...
\usepackage[top=85mm, bottom=85mm, outer=67mm, inner=67mm]{geometry}
...
\patchcmd{\ps@plain}{\thepage}{\bfseries\scriptsize\color{White}{\thepage}}{}{}
\makeatother
\begin{document}
\bfseries
\AddToShipoutPictureBG{\includegraphics[width=\paperwidth,height=\paperheight]{murex-3.jpg}}
...
\begin{titlepage}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth,keepaspectratio]{cover-white.png}
    \end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth,keepaspectratio]{fig01-white.png}
\end{figure}
\clearpage
