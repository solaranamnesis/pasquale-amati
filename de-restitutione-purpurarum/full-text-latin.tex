...
\begin{titlepage}
    ...
    % Title
    % -------------------------------------------------
    {\scshape\Huge Libellum de Restitutione Purpurarum}\\[0.2\baselineskip]
...
\begin{quotation}
\emph{formamque capit, quam lilia, si non}
...
\begin{quotation}
\emph{rubefactaque sanguine tellus}
...
\begin{quotation}
\emph{quae frondens purpurat auro,}
...
\emph{Nec tepidus pluvias concitat auster aquas.}

\emph{Ecce tibi similis, qui quondam Phryxon, et Hellen}

\emph{Diceris Inois eripuisse dolis.}

\emph{Hic undas imitatur, habet quoque nomen ab undis.}

\emph{Crediderim Nymphas hac ego veste tegi.}

\emph{Ille crocum simulat, croceo velatur amictu,}

\emph{Roscida luciferos cum Dea jungit equos.}

\emph{Hic Paphias myrtus, hic purpureas amethystos}

\emph{Albentesve rosas, Threiciamque gruem.}

\emph{Nec glandes, Amarylli, tuae, nec amygdala desunt,}

\emph{Et sua velleribus nomina cera dedit.}

\emph{Quot nova terra parit flores, cum vere tepenti}

\emph{Vitis agit gemmas, pigraque cedit hiems,}
...
\emph{rubri vilem sub tegmine cocci}
...
\emph{Vestis radiato murice solem}
...
\emph{Quid confert purpura major}
...
\emph{gremioque rigentia profert}
...
\emph{pater huic} (Arachne) \emph{Colophonius Idmon}
...
10. Plurimae purpurae in arido positae humorem praebuerunt, positae in aqua marina viguerunt: unde colligi possit hunc humorem eorum vitae non necessarium contra Plinii opinionem dicentis, \emph{cum vita succum evomunt.}*
